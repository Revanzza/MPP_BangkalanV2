...
<a href="{{ route('services.instansi', $institution->slug) }}" class="flex flex-col items-center transition-transform duration-200 cursor-pointer group hover:scale-105">
    <div class="flex items-center justify-center w-24 h-24 mb-1 overflow-hidden bg-white rounded-full">
        ...
        @else
            <div class="flex items-center justify-center w-20 h-20 text-gray-400 bg-gray-100 rounded-full">
