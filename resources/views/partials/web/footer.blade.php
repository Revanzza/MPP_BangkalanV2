<footer class="bg-blue-700 text-white py-5">
    <div class="max-w-6xl mx-auto px-4">
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="md:w-1/2">
                <h5 class="font-bold text-lg">KONTAK KAMI</h5>
                <div class="flex items-start mt-4">
                    <img src="{{ asset('images/mpp-bangkalan.png') }}" alt="Logo" class="h-24 mr-4">
                    <div>
                        <p class="font-bold mb-1">MAL PELAYANAN PUBLIK KABUPATEN BANGKALAN</p>
            ...
            <div class="md:w-1/2 text-center md:text-right">
                ...
                <div class="mt-4 space-y-3">
                    <a href="#" class="inline-flex items-center text-white hover:text-gray-200 transition">
                        <div class="w-12 h-14 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center text-2xl mr-3 transition transform hover:scale-110">
