...
<div class="flex flex-col items-center justify-center min-h-screen space-y-6 bg-gray-100">
    <div class="w-full max-w-md p-8 text-center bg-white rounded shadow">
        ...
        @else
            <div class="mb-2 text-lg text-gray-500">Semua antrean hari ini sudah selesai dilayani.</div>
        @endif
    </div>
    <div class="w-full max-w-md p-8 text-center bg-white rounded shadow">
        ...
        <p class="mb-4 text-sm italic text-gray-600">*Nb: ScreenShoot Nomer Antrian Anda Sebagai Bukti</p>
